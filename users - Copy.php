...
<div id="displaytable">
        ...
        <div id="tabdiv">
        <a href="registerbkup.php"><button class="add">New User+</button></a>
    <table class="table table-bordered" id="tab">
        ...
        <tbody>
            ...
            <tr>
             ...
             <td class="tab_data action_butt"><a><button id="del" onclick = "deleted('<?php echo $row['user_id']?>')" value = "<?php echo $row['user_id']?>">Delete</button></a>
             <a href= "edit.php?id=<?php echo $row['user_id']?> & crazy"  ><button >Edit</button></a>
            </td> 
            </tr>
        <?php 
        $i++;
